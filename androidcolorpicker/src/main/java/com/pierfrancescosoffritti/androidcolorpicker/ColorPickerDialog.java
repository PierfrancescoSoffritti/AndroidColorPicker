...
public class ColorPickerDialog extends DialogFragment implements ColorPickerSwatch.OnColorSelectedListener {
    ...
    @StringRes protected int mTitleResId = R.string.color_picker_default_title;
    protected int[] mColors = null;
    protected String[] mColorContentDescriptions = null;
    protected int mSelectedColor;
    protected int mColumns;
    @SwatchesSize protected int mSize;
    ...
    public static ColorPickerDialog newInstance(@StringRes int titleResId, int[] colors, int selectedColor, int columns, @SwatchesSize int size) {
        ColorPickerDialog ret = new ColorPickerDialog();
        ret.initialize(titleResId, colors, selectedColor, columns, size);
        return ret;
    }

    public void initialize(@StringRes int titleResId, int[] colors, int selectedColor, int columns, @SwatchesSize int size) {
        setArguments(titleResId, columns, size);
        setColors(colors, selectedColor);
    }

    public void setArguments(@StringRes int titleResId, int columns, @SwatchesSize int size) {
    ...
    public void onColorSelected(int color) {
        ...
        if (getTargetFragment() instanceof ColorPickerSwatch.OnColorSelectedListener) {
            final ColorPickerSwatch.OnColorSelectedListener listener = (ColorPickerSwatch.OnColorSelectedListener) getTargetFragment();
